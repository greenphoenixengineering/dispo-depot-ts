...
// The component requires users to be authenticated. If not, they will be redirected to login.
// It will prefill the Checkout data with the user's email for faster checkout
const ButtonCheckout = ({
  ...
  const handlePayment = async () => {
    ...
    try {
      const response = await apiClient.post<any, CheckoutResponse>(
