  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <p className="text-xs sm:text-sm text-gray-500 mb-4">Select tags to target specific buyer groups:</p>
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          <div className="flex items-center">
            ...
            />
            <label htmlFor="tag-retail" className="ml-2 block text-xs sm:text-sm text-gray-900">
              Retail
            </label>
          </div>
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
            />
            <label htmlFor="tag-wholesale" className="ml-2 block text-xs sm:text-sm text-gray-900">
              Wholesale
            </label>
          </div>
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
            />
            <label htmlFor="tag-vip" className="ml-2 block text-xs sm:text-sm text-gray-900">
              VIP
            </label>
          </div>
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
            />
            <label htmlFor="tag-new" className="ml-2 block text-xs sm:text-sm text-gray-900">
              New
            </label>
          </div>
        </div>
        ...
        <div className="flex justify-end">
          <button
            type="button"
            className="inline-flex items-center gap-2 bg-green-500 text-white rounded-md px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm hover:bg-green-600 transition-colors"
          >
            Send Deal
          </button>
        </div>
